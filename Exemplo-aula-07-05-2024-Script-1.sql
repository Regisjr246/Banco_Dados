...
select * from pizza_sem_movimento psm ;



create table estado_brasil(id int auto_increment primary key,
nome varchar(50)
);

insert into estado_brasil (nome) values 
('Acre'),
('Alagoas'),
('Amapá'),
('Amazonas'),
...
(select nome from estado_brasil where id=estado_aleatorio));
set i =i + 1 ;
end while;
end//
delimiter ;
