...
-- Inserir alunos
insert into alunos (nome, dt_nascimento, endereco) values
...
inner join notas n  on a.id_aluno = n.id_aluno
inner join disciplinas d on n.id_disciplina =d.id_disciplina
where d.nome ='MAT101'and n.nota >= 7 
order by aluno,disciplina;
...
-- Exercicio 14
select count(m.id_aluno) as total_alunos
from disciplinas d
...
from notas n 
inner join disciplinas d  on d.id_disciplina  = n.id_disciplina 
where d.nome='Hístoria';

-- OU


select n.nota as maior_nota
from notas n 
inner join disciplinas d on d.id_disciplina =n.id_disciplina 
...
select d.nome as id_disciplina, count(m.id_aluno) tota_Alunos
from disciplinas d 
...
-- Exercicio 21
select max(n.nota) as menor_notas
from notas n 
inner join disciplinas d  on d.id_disciplina  = n.id_disciplina;
...
-- Exercicio 22
select min(n.nota) as menor_notas
from notas n 
inner join disciplinas d  on d.id_disciplina  = n.id_disciplina;
...
-- Exercicio 23
select avg(n.nota) as menor_notas
from notas n 
inner join disciplinas d  on d.id_disciplina  = n.id_disciplina;

-- Exercicio 24
select d.nome as disciplinas, avg(n.nota) as media
from disciplinas d 
inner join notas n on d.id_disciplina =n.id_disciplina
group by d.nome ;

-- Exercicio 25
select d.nome as disciplinas, a.nome as aluno, avg(n.nota) as media
from disciplinas d 
inner join notas n on d.id_disciplina =n.id_disciplina
...
inner join alunos a on n.id_aluno =a.id_aluno 
group by d.nome, a.nome
order by disciplinas, media desc;

-- Exercicio 27

select d.nome as disciplinas, a.nome as aluno, n.nota as cinco_menores_notas_historia
from notas n 
inner join disciplinas d on d.id_disciplina =n.id_disciplina 
inner join alunos a on n.id_aluno =a.id_aluno 
where d.nome ='História'
order by cinco_menores_notas_historia asc 
limit 5;
...
-- Exercicio 30
select  count(distinct id_aluno) as tota_alunos from matriculas m ;
