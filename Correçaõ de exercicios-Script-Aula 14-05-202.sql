...
-- Exercicio 3: calcular_horas_projetos
delimiter //

create function calcular_horas_projetos (id int) returns int
begin
...
select calcular_horas_projetos(3);


-- Exercicio 3 : calcular_custo_projetos

delimiter //

create function calcular_custo_projetos (id int) returns decimal(15,2)
begin
	declare total_custo decimal(15,2);
select sum(horas_trabalhadas * valor_hora) into total_custo  from funcionarios_projetos 
where id_projeto = id;
return total_custo;
end //
...
select calcular_custo_projetos(3);




-- Exercicio 2: inserir_funcionario

delimiter //
create procedure inserir_funcionario(x_nome varchar(255), x_email varchar(255),
x_departamento int, x_valor_hora decimal(15,2))
begin 
	insert into funcionarios (nome, email, id_departamento, valor_hora)
	values(x_nome, x_email, x_departamento, x_valor_hora);
end //
delimiter ;
...
select * from funcionarios f;
 ...
 -- Exercicio 2
delimiter // 
create procedure calcular_valor_total_projetos(id int)
begin
	update projetos 
...
delimiter ;
  ...
  call calcular_valor_total_projetos (1);
